pub const XC4000E_WIRES: &[(&str, &str)] = &[
    ...
    ("CENTER_SEG_72", "SINGLE.H0.W"),  // H1R
    ("CENTER_SEG_73", "SINGLE.H0"),    // H1
    ("CENTER_SEG_74", "SINGLE.H1.W"),  // H2R
    ("CENTER_SEG_75", "SINGLE.H1"),    // H2
    ("CENTER_SEG_76", "SINGLE.H2.W"),  // H3R
    ("CENTER_SEG_77", "SINGLE.H2"),    // H3
    ("CENTER_SEG_78", "SINGLE.H3.W"),  // H4R
    ("CENTER_SEG_79", "SINGLE.H3"),    // H4
    ("CENTER_SEG_80", "SINGLE.H4.W"),  // H5R
    ("CENTER_SEG_81", "SINGLE.H4"),    // H5
    ("CENTER_SEG_82", "SINGLE.H5.W"),  // H6R
    ("CENTER_SEG_83", "SINGLE.H5"),    // H6
    ("CENTER_SEG_84", "SINGLE.H6.W"),  // H7R
    ("CENTER_SEG_85", "SINGLE.H6"),    // H7
    ("CENTER_SEG_86", "SINGLE.H7.W"),  // H8R
    ("CENTER_SEG_87", "SINGLE.H7"),    // H8
    ("CENTER_SEG_88", "DOUBLE.H1.0"),  // DH3R
    ("CENTER_SEG_89", "DOUBLE.H1.2"),  // DH3
    ("CENTER_SEG_90", "DOUBLE.V1.0"),  // DV3T
    ...
    ("CENTER_SEG_99", "DOUBLE.V0.0"),  // DV2T
    ...
    ("BOT_SEG_3", "IO.DMUX.H0"),       // DMUX_OUTER
    ("BOT_SEG_4", "IO.DMUX.H1"),       // DMUX_INNER
    ...
    ("BOT_SEG_91", "SINGLE.H0.W"),   // H1R
    ("BOT_SEG_92", "SINGLE.H0"),     // H1
    ("BOT_SEG_93", "SINGLE.H1.W"),   // H2R
    ("BOT_SEG_94", "SINGLE.H1"),     // H2
    ("BOT_SEG_95", "SINGLE.H2.W"),   // H3R
    ("BOT_SEG_96", "SINGLE.H2"),     // H3
    ("BOT_SEG_97", "SINGLE.H3.W"),   // H4R
    ("BOT_SEG_98", "SINGLE.H3"),     // H4
    ("BOT_SEG_99", "SINGLE.H4.W"),   // H5R
    ("BOT_SEG_100", "SINGLE.H4"),    // H5
    ("BOT_SEG_101", "SINGLE.H5.W"),  // H6R
    ("BOT_SEG_102", "SINGLE.H5"),    // H6
    ("BOT_SEG_103", "SINGLE.H6.W"),  // H7R
    ("BOT_SEG_104", "SINGLE.H6"),    // H7
    ("BOT_SEG_105", "SINGLE.H7.W"),  // H8R
    ("BOT_SEG_106", "SINGLE.H7"),    // H8
    ("BOT_SEG_107", "DOUBLE.H1.0"),  // DH3R
    ("BOT_SEG_108", "DOUBLE.H1.2"),  // DH3
    ("BOT_SEG_109", "DOUBLE.V1.0"),  // DV3T
    ...
    ("BOTR_SEG_3", "IO.DMUX.H0"),       // DMUX_OUTER
    ("BOTR_SEG_4", "IO.DMUX.H1"),       // DMUX_INNER
    ...
    ("BOTR_SEG_91", "SINGLE.H0.W"),   // H1R
    ("BOTR_SEG_92", "SINGLE.H0"),     // H1
    ("BOTR_SEG_93", "SINGLE.H1.W"),   // H2R
    ("BOTR_SEG_94", "SINGLE.H1"),     // H2
    ("BOTR_SEG_95", "SINGLE.H2.W"),   // H3R
    ("BOTR_SEG_96", "SINGLE.H2"),     // H3
    ("BOTR_SEG_97", "SINGLE.H3.W"),   // H4R
    ("BOTR_SEG_98", "SINGLE.H3"),     // H4
    ("BOTR_SEG_99", "SINGLE.H4.W"),   // H5R
    ("BOTR_SEG_100", "SINGLE.H4"),    // H5
    ("BOTR_SEG_101", "SINGLE.H5.W"),  // H6R
    ("BOTR_SEG_102", "SINGLE.H5"),    // H6
    ("BOTR_SEG_103", "SINGLE.H6.W"),  // H7R
    ("BOTR_SEG_104", "SINGLE.H6"),    // H7
    ("BOTR_SEG_105", "SINGLE.H7.W"),  // H8R
    ("BOTR_SEG_106", "SINGLE.H7"),    // H8
    ("BOTR_SEG_107", "DOUBLE.H1.0"),  // DH3R
    ("BOTR_SEG_108", "DOUBLE.H1.2"),  // DH3
    ("BOTR_SEG_109", "DOUBLE.V1.0"),  // DV3T
    ...
    ("BOTS_SEG_3", "IO.DMUX.H0"),       // DMUX_OUTER
    ("BOTS_SEG_4", "IO.DMUX.H1"),       // DMUX_INNER
    ...
    ("BOTS_SEG_91", "SINGLE.H0.W"),   // H1R
    ("BOTS_SEG_92", "SINGLE.H0"),     // H1
    ("BOTS_SEG_93", "SINGLE.H1.W"),   // H2R
    ("BOTS_SEG_94", "SINGLE.H1"),     // H2
    ("BOTS_SEG_95", "SINGLE.H2.W"),   // H3R
    ("BOTS_SEG_96", "SINGLE.H2"),     // H3
    ("BOTS_SEG_97", "SINGLE.H3.W"),   // H4R
    ("BOTS_SEG_98", "SINGLE.H3"),     // H4
    ("BOTS_SEG_99", "SINGLE.H4.W"),   // H5R
    ("BOTS_SEG_100", "SINGLE.H4"),    // H5
    ("BOTS_SEG_101", "SINGLE.H5.W"),  // H6R
    ("BOTS_SEG_102", "SINGLE.H5"),    // H6
    ("BOTS_SEG_103", "SINGLE.H6.W"),  // H7R
    ("BOTS_SEG_104", "SINGLE.H6"),    // H7
    ("BOTS_SEG_105", "SINGLE.H7.W"),  // H8R
    ("BOTS_SEG_106", "SINGLE.H7"),    // H8
    ("BOTS_SEG_107", "DOUBLE.H1.0"),  // DH3R
    ("BOTS_SEG_108", "DOUBLE.H1.2"),  // DH3
    ("BOTS_SEG_109", "DOUBLE.V1.0"),  // DV3T
    ...
    ("BOTSL_SEG_3", "IO.DMUX.H0"),       // DMUX_OUTER
    ("BOTSL_SEG_4", "IO.DMUX.H1"),       // DMUX_INNER
    ...
    ("BOTSL_SEG_89", "SINGLE.H0.W"),   // H1R
    ("BOTSL_SEG_90", "SINGLE.H0"),     // H1
    ("BOTSL_SEG_91", "SINGLE.H1.W"),   // H2R
    ("BOTSL_SEG_92", "SINGLE.H1"),     // H2
    ("BOTSL_SEG_93", "SINGLE.H2.W"),   // H3R
    ("BOTSL_SEG_94", "SINGLE.H2"),     // H3
    ("BOTSL_SEG_95", "SINGLE.H3.W"),   // H4R
    ("BOTSL_SEG_96", "SINGLE.H3"),     // H4
    ("BOTSL_SEG_97", "SINGLE.H4.W"),   // H5R
    ("BOTSL_SEG_98", "SINGLE.H4"),     // H5
    ("BOTSL_SEG_99", "SINGLE.H5.W"),   // H6R
    ("BOTSL_SEG_100", "SINGLE.H5"),    // H6
    ("BOTSL_SEG_101", "SINGLE.H6.W"),  // H7R
    ("BOTSL_SEG_102", "SINGLE.H6"),    // H7
    ("BOTSL_SEG_103", "SINGLE.H7.W"),  // H8R
    ("BOTSL_SEG_104", "SINGLE.H7"),    // H8
    ("BOTSL_SEG_105", "DOUBLE.H1.0"),  // DH3R
    ("BOTSL_SEG_106", "DOUBLE.H1.2"),  // DH3
    ("BOTSL_SEG_107", "DOUBLE.V1.0"),  // DV3T
    ...
    ("BOTSL_SEG_116", "DOUBLE.V0.0"),  // DV2T
    ...
    ("TOP_SEG_23", "DOUBLE.V1.2"),      // DV3
    ("TOP_SEG_24", "SINGLE.V5"),        // V6
    ("TOP_SEG_26", "DOUBLE.V0.1"),      // DV1
    ("TOP_SEG_27", "DOUBLE.V0.2"),      // DV2
    // TOP_SEG_31 CE_2L
    ("TOP_SEG_40", "GCLK3"),            // K4
    ...
    ("TOP_SEG_72", "IO.DMUX.H0"),      // DMUX_OUTER
    ("TOP_SEG_73", "IO.DMUX.H1"),      // DMUX_INNER
    ...
    ("TOPR_SEG_23", "DOUBLE.V1.2"),      // DV3
    ("TOPR_SEG_24", "SINGLE.V5"),        // V6
    ("TOPR_SEG_26", "DOUBLE.V0.1"),      // DV1
    ("TOPR_SEG_27", "DOUBLE.V0.2"),      // DV2
    // TOPR_SEG_31 CE_2L
    ...
    ("TOPR_SEG_72", "IO.DMUX.H0"),      // DMUX_OUTER
    ("TOPR_SEG_73", "IO.DMUX.H1"),      // DMUX_INNER
    ...
    ("TOPS_SEG_23", "DOUBLE.V1.2"),      // DV3
    ("TOPS_SEG_24", "SINGLE.V5"),        // V6
    ("TOPS_SEG_26", "DOUBLE.V0.1"),      // DV1
    ("TOPS_SEG_27", "DOUBLE.V0.2"),      // DV2
    // TOPS_SEG_31 CE_2L
    ...
    ("TOPS_SEG_72", "IO.DMUX.H0"),      // DMUX_OUTER
    ("TOPS_SEG_73", "IO.DMUX.H1"),      // DMUX_INNER
    ...
    ("TOPSL_SEG_23", "DOUBLE.V1.2"),      // DV3
    ("TOPSL_SEG_24", "SINGLE.V5"),        // V6
    ("TOPSL_SEG_25", "DOUBLE.V0.2"),      // DV2
    // TOPSL_SEG_29 CE_2L
    ...
    ("TOPSL_SEG_70", "IO.DMUX.H0"),      // DMUX_OUTER
    ("TOPSL_SEG_71", "IO.DMUX.H1"),      // DMUX_INNER
    ...
    ("RT_SEG_85", "IO.DMUX.V0"),       // DMUX_OUTER
    ("RT_SEG_86", "LONG.H4"),          // HLL5
    ("RT_SEG_87", "IO.DMUX.V1"),       // DMUX_INNER
    ...
    ("RT_SEG_99", "SINGLE.H0.W"),       // H1R
    ("RT_SEG_100", "OUT.LR.IOB1.I2.S"), // I2_2T
    ("RT_SEG_101", "SINGLE.H0"),        // H1
    ("RT_SEG_102", "SINGLE.H1.W"),      // H2R
    ("RT_SEG_103", "SINGLE.H1"),        // H2
    ("RT_SEG_104", "SINGLE.H2.W"),      // H3R
    // RT_SEG_105 OK_2T
    // RT_SEG_106 IK_2T
    ("RT_SEG_107", "SINGLE.H2"),   // H3
    ("RT_SEG_108", "SINGLE.H3.W"), // H4R
    ("RT_SEG_109", "SINGLE.H3"),   // H4
    ("RT_SEG_110", "SINGLE.H4.W"), // H5R
    ("RT_SEG_111", "SINGLE.H4"),   // H5
    ("RT_SEG_112", "SINGLE.H5.W"), // H6R
    ("RT_SEG_113", "SINGLE.H5"),   // H6
    ("RT_SEG_114", "SINGLE.H6.W"), // H7R
    ("RT_SEG_115", "SINGLE.H6"),   // H7
    ("RT_SEG_116", "SINGLE.H7.W"), // H8R
    ("RT_SEG_117", "SINGLE.H7"),   // H8
    ("RT_SEG_118", "DOUBLE.H1.0"), // DH3R
    ("RT_SEG_119", "DOUBLE.H1.2"), // DH3
    ("RT_SEG_120", "DOUBLE.H1.1"), // DH4
    ("RT_SEG_121", "DOUBLE.V1.0"), // DV3T
    ...
    ("RTT_SEG_85", "IO.DMUX.V0"),       // DMUX_OUTER
    ("RTT_SEG_86", "LONG.H4"),          // HLL5
    ("RTT_SEG_87", "IO.DMUX.V1"),       // DMUX_INNER
    ...
    ("RTT_SEG_98", "SINGLE.H0.W"),      // H1R
    ("RTT_SEG_99", "OUT.LR.IOB1.I2.S"), // I2_2T
    ("RTT_SEG_100", "SINGLE.H0"),       // H1
    ("RTT_SEG_101", "SINGLE.H1.W"),     // H2R
    ("RTT_SEG_102", "SINGLE.H1"),       // H2
    ("RTT_SEG_103", "SINGLE.H2.W"),     // H3R
    // RTT_SEG_104 OK_2T
    ("RTT_SEG_105", "SINGLE.H2"),   // H3
    ("RTT_SEG_106", "SINGLE.H3.W"), // H4R
    ("RTT_SEG_107", "SINGLE.H3"),   // H4
    ("RTT_SEG_108", "SINGLE.H4.W"), // H5R
    ("RTT_SEG_109", "SINGLE.H4"),   // H5
    ("RTT_SEG_110", "SINGLE.H5.W"), // H6R
    ("RTT_SEG_111", "SINGLE.H5"),   // H6
    ("RTT_SEG_112", "SINGLE.H6.W"), // H7R
    ("RTT_SEG_113", "SINGLE.H6"),   // H7
    ("RTT_SEG_114", "SINGLE.H7.W"), // H8R
    ("RTT_SEG_115", "SINGLE.H7"),   // H8
    ("RTT_SEG_116", "DOUBLE.H1.0"), // DH3R
    ("RTT_SEG_117", "DOUBLE.H1.2"), // DH3
    ("RTT_SEG_118", "DOUBLE.H1.1"), // DH4
    ("RTT_SEG_119", "DOUBLE.V1.0"), // DV3T
    ...
    ("RTS_SEG_85", "IO.DMUX.V0"),       // DMUX_OUTER
    ("RTS_SEG_86", "LONG.H4"),          // HLL5
    ("RTS_SEG_87", "IO.DMUX.V1"),       // DMUX_INNER
    ...
    ("RTS_SEG_99", "SINGLE.H0.W"),       // H1R
    ("RTS_SEG_100", "OUT.LR.IOB1.I2.S"), // I2_2T
    ("RTS_SEG_101", "SINGLE.H0"),        // H1
    ("RTS_SEG_102", "SINGLE.H1.W"),      // H2R
    ("RTS_SEG_103", "SINGLE.H1"),        // H2
    ("RTS_SEG_104", "SINGLE.H2.W"),      // H3R
    // RTS_SEG_105 OK_2T
    // RTS_SEG_106 IK_2T
    ("RTS_SEG_107", "SINGLE.H2"),   // H3
    ("RTS_SEG_108", "SINGLE.H3.W"), // H4R
    ("RTS_SEG_109", "SINGLE.H3"),   // H4
    ("RTS_SEG_110", "SINGLE.H4.W"), // H5R
    ("RTS_SEG_111", "SINGLE.H4"),   // H5
    ("RTS_SEG_112", "SINGLE.H5.W"), // H6R
    ("RTS_SEG_113", "SINGLE.H5"),   // H6
    ("RTS_SEG_114", "SINGLE.H6.W"), // H7R
    ("RTS_SEG_115", "SINGLE.H6"),   // H7
    ("RTS_SEG_116", "SINGLE.H7.W"), // H8R
    ("RTS_SEG_117", "SINGLE.H7"),   // H8
    ("RTS_SEG_118", "DOUBLE.H1.0"), // DH3R
    ("RTS_SEG_119", "DOUBLE.H1.2"), // DH3
    ("RTS_SEG_120", "DOUBLE.H1.1"), // DH4
    ("RTS_SEG_121", "DOUBLE.V1.0"), // DV3T
    ...
    ("RTSB_SEG_85", "IO.DMUX.V0"),       // DMUX_OUTER
    ("RTSB_SEG_86", "LONG.H4"),          // HLL5
    ("RTSB_SEG_87", "IO.DMUX.V1"),       // DMUX_INNER
    ...
    ("RTSB_SEG_99", "SINGLE.H0.W"),       // H1R
    ("RTSB_SEG_100", "OUT.LR.IOB1.I2.S"), // I2_2T
    ("RTSB_SEG_101", "SINGLE.H0"),        // H1
    ("RTSB_SEG_102", "SINGLE.H1.W"),      // H2R
    ("RTSB_SEG_103", "SINGLE.H1"),        // H2
    ("RTSB_SEG_104", "SINGLE.H2.W"),      // H3R
    // RTSB_SEG_105 OK_2T
    // RTSB_SEG_106 IK_2T
    ("RTSB_SEG_107", "SINGLE.H2"),   // H3
    ("RTSB_SEG_108", "SINGLE.H3.W"), // H4R
    ("RTSB_SEG_109", "SINGLE.H3"),   // H4
    ("RTSB_SEG_110", "SINGLE.H4.W"), // H5R
    ("RTSB_SEG_111", "SINGLE.H4"),   // H5
    ("RTSB_SEG_112", "SINGLE.H5.W"), // H6R
    ("RTSB_SEG_113", "SINGLE.H5"),   // H6
    ("RTSB_SEG_114", "SINGLE.H6.W"), // H7R
    ("RTSB_SEG_115", "SINGLE.H6"),   // H7
    ("RTSB_SEG_116", "SINGLE.H7.W"), // H8R
    ("RTSB_SEG_117", "SINGLE.H7"),   // H8
    ("RTSB_SEG_118", "DOUBLE.H1.0"), // DH3R
    ("RTSB_SEG_119", "DOUBLE.H1.2"), // DH3
    ("RTSB_SEG_120", "DOUBLE.H1.1"), // DH4
    ("RTSB_SEG_121", "DOUBLE.V1.0"), // DV3T
    ...
    ("LEFT_SEG_62", "IO.DMUX.V0"),       // DMUX_OUTER
    ("LEFT_SEG_63", "LONG.H5"),          // HLL6
    ("LEFT_SEG_65", "DOUBLE.H0.0"),      // DH1
    ("LEFT_SEG_64", "IO.DMUX.V1"),       // DMUX_INNER
    ...
    ("LEFT_SEG_70", "SINGLE.H1.W"),      // H2
    // LEFT_SEG_71: CE_2T
    ("LEFT_SEG_72", "DOUBLE.H0.1"),      // DH2
    ("LEFT_SEG_74", "IO.DOUBLE.1.W.2"),  // LDV3
    ("LEFT_SEG_75", "OUT.LR.IOB1.I2.S"), // I2_2T
    ("LEFT_SEG_76", "SINGLE.H0.W"),      // H1
    ("LEFT_SEG_77", "SINGLE.H2.W"),      // H3
    // LEFT_SEG_78: IK_2T
    // LEFT_SEG_79: OK_2T
    ("LEFT_SEG_80", "SINGLE.H3.W"), // H4
    ("LEFT_SEG_81", "SINGLE.H4.W"), // H5
    ("LEFT_SEG_82", "SINGLE.H5.W"), // H6
    ("LEFT_SEG_83", "SINGLE.H6.W"), // H7
    ("LEFT_SEG_84", "SINGLE.H7.W"), // H8
    ...
    ("LEFTT_SEG_62", "IO.DMUX.V0"),       // DMUX_OUTER
    ("LEFTT_SEG_63", "LONG.H5"),          // HLL6
    ("LEFTT_SEG_65", "DOUBLE.H0.0"),      // DH1
    ("LEFTT_SEG_64", "IO.DMUX.V1"),       // DMUX_INNER
    ...
    ("LEFTT_SEG_70", "SINGLE.H1.W"),      // H2
    // LEFTT_SEG_71: CE_2T
    ("LEFTT_SEG_72", "DOUBLE.H0.1"),      // DH2
    ("LEFTT_SEG_73", "IO.DOUBLE.1.W.2"),  // LDV3
    ("LEFTT_SEG_74", "OUT.LR.IOB1.I2.S"), // I2_2T
    ("LEFTT_SEG_75", "SINGLE.H0.W"),      // H1
    ("LEFTT_SEG_76", "SINGLE.H2.W"),      // H3
    // LEFTT_SEG_77: IK_2T
    ("LEFTT_SEG_78", "SINGLE.H3.W"), // H4
    ("LEFTT_SEG_79", "SINGLE.H4.W"), // H5
    ("LEFTT_SEG_80", "SINGLE.H5.W"), // H6
    ("LEFTT_SEG_81", "SINGLE.H6.W"), // H7
    ("LEFTT_SEG_82", "SINGLE.H7.W"), // H8
    ...
    ("LEFTS_SEG_62", "IO.DMUX.V0"),       // DMUX_OUTER
    ("LEFTS_SEG_63", "LONG.H5"),          // HLL6
    ("LEFTS_SEG_65", "DOUBLE.H0.0"),      // DH1
    ("LEFTS_SEG_64", "IO.DMUX.V1"),       // DMUX_INNER
    ...
    ("LEFTS_SEG_75", "SINGLE.H0.W"),      // H1
    ("LEFTS_SEG_76", "SINGLE.H1.W"),      // H2
    ("LEFTS_SEG_77", "SINGLE.H2.W"),      // H3
    // LEFTS_SEG_78: IK_2T
    // LEFTS_SEG_79: OK_2T
    ("LEFTS_SEG_80", "SINGLE.H3.W"), // H4
    ("LEFTS_SEG_81", "SINGLE.H4.W"), // H5
    ("LEFTS_SEG_82", "SINGLE.H5.W"), // H6
    ("LEFTS_SEG_83", "SINGLE.H6.W"), // H7
    ("LEFTS_SEG_84", "SINGLE.H7.W"), // H8
    ...
    ("LEFTSB_SEG_62", "IO.DMUX.V0"),       // DMUX_OUTER
    ("LEFTSB_SEG_63", "LONG.H5"),          // HLL6
    ("LEFTSB_SEG_65", "DOUBLE.H0.0"),      // DH1
    ("LEFTSB_SEG_64", "IO.DMUX.V1"),       // DMUX_INNER
    ...
    ("LEFTSB_SEG_75", "SINGLE.H0.W"),      // H1
    ("LEFTSB_SEG_76", "SINGLE.H1.W"),      // H2
    ("LEFTSB_SEG_77", "SINGLE.H2.W"),      // H3
    // LEFTSB_SEG_78: IK_2T
    // LEFTSB_SEG_79: OK_2T
    ("LEFTSB_SEG_80", "SINGLE.H3.W"), // H4
    ("LEFTSB_SEG_81", "SINGLE.H4.W"), // H5
    ("LEFTSB_SEG_82", "SINGLE.H5.W"), // H6
    ("LEFTSB_SEG_83", "SINGLE.H6.W"), // H7
    ("LEFTSB_SEG_84", "SINGLE.H7.W"), // H8
    ...
    ("TIE_KK_1_O", "GND"),
    ("LR_SEG_0", "IO.DMUX.H0"),       // BDMUX_OUTER
    ("LR_SEG_1", "IO.DOUBLE.0.E.1"),  // RDV1
    ("LR_SEG_2", "IO.DMUX.H1"),       // BDMUX_INNER
    ...
    ("LR_SEG_78", "IO.DMUX.V0"),       // RDMUX_OUTER
    ("LR_SEG_79", "LONG.H4"),          // HLL5
    ("LR_SEG_80", "IO.DMUX.V1"),       // RDMUX_INNER
    ...
    ("LR_SEG_92", "SINGLE.H0.W"),      // H1R
    ("LR_SEG_93", "OUT.LR.IOB1.I2.S"), // TI2_2
    ("LR_SEG_94", "SINGLE.H0"),        // H1
    ("LR_SEG_95", "SINGLE.H1.W"),      // H2R
    ("LR_SEG_96", "SINGLE.H1"),        // H2
    ("LR_SEG_97", "SINGLE.H2.W"),      // H3R
    // LR_SEG_98 TOK_2
    // LR_SEG_99 TIK_2
    ("LR_SEG_100", "SINGLE.H2"),   // H3
    ("LR_SEG_101", "SINGLE.H3.W"), // H4R
    ("LR_SEG_102", "SINGLE.H3"),   // H4
    ("LR_SEG_103", "SINGLE.H4.W"), // H5R
    ("LR_SEG_104", "SINGLE.H4"),   // H5
    ("LR_SEG_105", "SINGLE.H5.W"), // H6R
    ("LR_SEG_106", "SINGLE.H5"),   // H6
    ("LR_SEG_107", "SINGLE.H6.W"), // H7R
    ("LR_SEG_108", "SINGLE.H6"),   // H7
    ("LR_SEG_109", "SINGLE.H7.W"), // H8R
    ("LR_SEG_110", "SINGLE.H7"),   // H8
    ("LR_SEG_111", "DOUBLE.H1.0"), // DH3R
    ("LR_SEG_112", "DOUBLE.H1.2"), // DH3
    ("LR_SEG_113", "DOUBLE.H1.1"), // DH4
    ("LR_SEG_114", "DOUBLE.V1.0"), // DV3T
    ...
    ("LR_SEG_123", "DOUBLE.V0.0"), // DV2T
    // UR
    ("TDO_O", "IMUX.TDO.O"),
    ("TDO_T", "IMUX.TDO.T"),
    ("UPDATE_O", "OUT.UPDATE.O"),
    ("OSC_F8M", "OUT.LR.IOB1.I1"),
    ("OSC_F500K", "OUT.OSC.OSC2"),
    ("OSC_F16K", "OUT.OSC.OSC3"),
    ("OSC_F490", "OUT.OSC.OSC4"),
    ("OSC_F15", "OUT.OSC.OSC5"),
    ...
    ("UR_SEG_30", "DOUBLE.V0.2"),      // DV2
    ("UR_SEG_31", "DOUBLE.V1.2"),      // DV3
    ...
    ("UR_SEG_76", "IO.DMUX.H0"),      // DMUX_OUTER
    ("UR_SEG_77", "IO.DMUX.H1"),      // DMUX_INNER
    ...
    ("LL_SEG_47", "IO.DMUX.V0"),       // DMUX_OUTER
    ("LL_SEG_48", "LONG.H5"),          // HLL6
    ("LL_SEG_49", "IO.DMUX.V1"),       // DMUX_INNER
    ...
    ("LL_SEG_55", "SINGLE.H1.W"),      // H2
    // LL_SEG_56 CE_2
    ("LL_SEG_57", "DOUBLE.H0.1"),      // DH2
    ("LL_SEG_59", "IO.DOUBLE.1.W.2"),  // D4
    ("LL_SEG_60", "OUT.LR.IOB1.I2.S"), // I2_2
    ("LL_SEG_61", "SINGLE.H0.W"),      // H1
    // LL_SEG_63 IK_2
    // LL_SEG_64 OK_2
    ("LL_SEG_62", "SINGLE.H2.W"), // H3
    ("LL_SEG_65", "SINGLE.H3.W"), // H4
    ("LL_SEG_66", "SINGLE.H4.W"), // H5
    ("LL_SEG_67", "SINGLE.H5.W"), // H6
    ("LL_SEG_68", "SINGLE.H6.W"), // H7
    ("LL_SEG_69", "SINGLE.H7.W"), // H8
