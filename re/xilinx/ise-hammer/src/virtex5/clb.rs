    ...
    for tile_name in ["CLBLL", "CLBLM"] {
        ...
        for i in 0..2 {
            ...
            for attr in ["A6LUT", "B6LUT", "C6LUT", "D6LUT"] {
                bctx.mode("SLICEL").test_multi_attr_lut(attr, 64);
            }
            ...
            match edev.kind {
                ...
                ChipKind::Virtex6 | ChipKind::Virtex7 => {
                    bctx.mode("SLICEL")
                        .attr("AFFINIT", "INIT1")
                        .attr("BFF", "")
                        .attr("CFF", "")
