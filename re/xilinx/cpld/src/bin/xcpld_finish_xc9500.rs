            ...
            pins: package
                ...
                .map(|(k, v)| {
                    (
                        k.clone(),
                        match *v {
                            PkgPin::Nc => xc9500::BondPin::Nc,
                            PkgPin::Gnd => xc9500::BondPin::Gnd,
                            PkgPin::VccInt => xc9500::BondPin::VccInt,
                            PkgPin::VccIo(bank) => {
                                xc9500::BondPin::VccIo(xc9500::BankId::from_idx(bank.to_idx()))
                            }
                            PkgPin::Jtag(JtagPin::Tck) => xc9500::BondPin::Tck,
