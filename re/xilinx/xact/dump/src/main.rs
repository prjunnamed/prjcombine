...
fn main() {
    ...
    let base: IntDb = match args.family.as_str() {
        "xc2000" => {
            bincode::decode_from_slice(prjcombine_xc2000::xc2000::INIT, bincode::config::standard())
                .unwrap()
                .0
        }
        "xc3000" | "xc3000a" => {
            bincode::decode_from_slice(prjcombine_xc2000::xc3000::INIT, bincode::config::standard())
                .unwrap()
                .0
        }
        _ => IntDb::default(),
