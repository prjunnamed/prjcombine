        ...
        for (tkn, kind) in [
            ...
            for &xy in self.builder.rd.tiles_by_kind_name(tkn) {
                ...
                for i in 0..24 {
                    bels.push(
                        self.builder
                            .bel_xy(bels::GCLK_PD_CLKBUF[i], "GCLK_PD", 0, i as u8)
        ...
        for tkn in [
            ...
            if let Some(&xy) = self.builder.rd.tiles_by_kind_name(tkn).iter().next() {
                ...
                for i in 0..2 {
                    let mut bel = self
                        .builder
                        .bel_xy(bels::DSP[i], "DSP", i as u8, 0)
        ...
        for tkn in ["HDIO_TILE", "HDIO_BOT_TILE"] {
            if let Some(&xy) = self.builder.rd.tiles_by_kind_name(tkn).iter().next() {
                ...
                for i in 0..11 {
                    bels.push(
                        self.builder
                            .bel_xy(bels::HDIOLOGIC[i], "HDIOLOGIC", 0, i as u8)
                ...
                for i in 0..11 {
                    bels.push(
                        self.builder
                            .bel_xy(bels::HDIOB[i], "IOB", 0, i as u8)
                ...
                for i in 0..4 {
                    let mut bel = self
                        .builder
                        .bel_xy(bels::BUFGCE_HDIO[i], "BUFGCE_HDIO", 0, i as u8)
                        .pin_name_only("O", 1)
                        .pin_name_only("I", 1);
                    for j in 0..8 {
                        bel = bel.extra_wire(
