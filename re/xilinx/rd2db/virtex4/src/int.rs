...
pub fn make_int_db(rd: &Part) -> (IntDb, NamingDb) {
    ...
    builder.make_marker_node("CLK_TERM", 0);
    builder.make_marker_node("HCLK_TERM", 0);
    builder.make_marker_node("HCLK_MGT", 0);
    builder.make_marker_node("HCLK_MGT_REPEATER", 0);
