...
use super::cfg::{GeomBuilderConfig, IntTileInfo, IntTermInfo, TieSiteInfo};
...
impl Virtex6GeomMaker {
    ...
    fn setup_int_ll(&mut self) {
        ...
        for i in 0..8 {
            ...
            self.builder.connect_int_wire(lh[16-i], Dir::E, lh[16-i-1]);
        }

        let lv: Vec<_> = (0..17).map(|i| {
        ...
        for i in 0..8 {
            ...
            self.builder.connect_int_wire(lv[16-i], Dir::S, lv[16-i-1]);
        }
    }
            ...
            for i in 0..4 {
                ...
                if i == 3 {
                    if let Some((Dir::N, x)) = dend {
                        let end_n = self.builder.make_int_wire(&format!("INT.{}END_N{}", name, i), "INT.QUAD", &[&format!("{}END_N{}_{}", name, x, i)]);
    ...
    fn setup_int_imux(&mut self) {
        ...
        for i in 0..2 {
            self.builder.make_int_wire(&format!("INT.IMUX.CTRL{}", i), "INT.IMUX.CTRL", &[&format!("CTRL_B{}", i)]);
        }
        for i in 0..8 {
    ...
    fn setup_buses_clk(&mut self) {
        ...
        for i in 0..8 {
            ...
            self.builder.register_int_wire(w, &[&format!("GCLK_B{}", i)]);
        }
    }
