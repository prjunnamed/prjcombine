...
impl Virtex4GeomMaker {
    pub fn new(family: &str) -> Self {
        ...
        let int_passes = vec![IntPassInfo::v("BRKH", "INT_BRKH")];
        ...
        let int_dbufs = vec![IntDoubleBufInfo::v_multi("PB", "PT", (7, 0), "INT_VPPC")];
    ...
    fn setup_int_ll(&mut self) {
        ...
        for i in 0..12 {
            ...
            self.builder
                .connect_int_wire(lh[24 - i], Dir::E, lh[24 - i - 1]);
        }
        ...
        for i in 0..12 {
            ...
            self.builder
                .connect_int_wire(lv[24 - i], Dir::N, lv[24 - i - 1]);
        }
    }
    ...
    fn setup_int_imux(&mut self) {
        ...
        for i in 0..4 {
            self.builder.make_int_wire(
                ...
                "INT.IMUX.CLK",
                &[&format!("CLK_B{}", i), &format!("CLK_B{}_DCM", i)],
            );
        }
        for i in 0..4 {
            self.builder.make_int_wire(
