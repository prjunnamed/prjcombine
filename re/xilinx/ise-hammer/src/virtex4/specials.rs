...
specials![
    ...
    IODELAY_I_FIXED,
    IODELAY_I_VARIABLE,
    IODELAY_I_VAR_LOADABLE,
    IODELAY_O_FIXED,
    IODELAY_O_VARIABLE,
    IODELAY_O_VAR_LOADABLE,
    IODELAY_IO_FIXED,
    IODELAY_I_FIXED_O_VARIABLE,
    IODELAY_I_VARIABLE_O_FIXED,
    IODELAY_IO_VAR_LOADABLE,
    IOI_OCLK90_BOTH,
    IOB_IPAD,
    IOB_CONTINUOUS,
    IOB_QUIET,
    ...
    IOB_OSTD_DIFF_FAST,
    IOB_OSTD_LVDS,
    IOB_OSTD_LVDS_GROUP0,
    IOB_OSTD_LVDS_GROUP1,
    IOB_OSTD_LVCMOS18_4_SLOW_EXCL,
    DRIVERBIAS_LV,
    DCM_CLKFB,
    DCM_PHASE_SHIFT_N1,
    ...
    PLL_COMPENSATION_ZHOLD,
    PLL_COMPENSATION_BUF_IN,
    PLL_COMPENSATION_CASCADE,
    PLL_TABLES_LOW,
    PLL_TABLES_HIGH,
    PLL_TABLES_SS,
    CENTER_DCI_BANK1,
